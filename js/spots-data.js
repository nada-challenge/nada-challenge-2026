/* ============================================================
   ...
   ■ 出所
     「灘チャレンジ2026_協賛店舗情報_統合版.xlsx」2026協賛店舗_統合シート（全58件）
     アンケートの「変更なし」は値ではなく無回答のため、キーごと省略しています。
     TODO: と書かれた店舗は情報が未確定です。掲載前に確認してください。

   ■ 更新履歴
     2026-08-21: 「ふくべ」を追加（統合版59行目。新規協賛店・広告協賛。
                  住所は公式サイト（fukube-kobe.com）で確認済み）
     2026-08-21: ベーカリーショップレマンの一言コメントを店舗からの修正依頼に基づき変更
                  （「おじいさんとおばあさんでやってます！」→「親子でやってます！」）
     2026-08-21: 冊子原稿（飲食店／食品販売／衣料雑貨／医療福祉／公共施設／その他）と
                  照合し、統合版で「未回答」または「去年原稿への修正指示」のまま
                  残っていた項目のみを補充。統合版に完結した文が入っている desc/body
                  および営業時間などの確定値は、冊子と内容が異なっていても変更していません
                  （冊子の一言コメントとWeb用コメントは別項目という整理のため）。
                  補充内容：
                    ・蒸し料理ひのき  desc/body（修正指示「30年」→「30年以上」の完成形）
                    ・美吉堂本舗      desc/body（断片「創業97年」の完成形）、wheelchair
                    ・畳インテリア森商店 desc/body（修正指示「創業107年」の完成形）
                    ・赤玉スポーツ    desc/body、住所
                    ・井神鮮魚店      住所（原本の住所欄が「あ」だったもの）
                    ・アトリエパルファン 住所（原本が掲載依頼文だったもの）
                    ・ろっこう医療生協 電話・営業時間・定休日
                    ・寿建設労働者ユニオン 定休日
                    ・mochi books    定休日
                    ・Brasserie a Route 表示名の正規化（brasserie_a_route から）
                    ・芦屋           正式名称に修正（弁護士法人芦屋西宮市民法律事務所）
   ============================================================ */
window.NADA_DATA = {
  ...
  spots: [
    ...
    },
    {
      ...
      name: "ベーカリーショップレマン",
      category: "food",
      desc: "親子でやってます！サンドイッチと辛口カレー、チョコパンダが人気。夏はあんバター塩がおすすめ！",
      body: "親子でやってます！サンドイッチと辛口カレー、チョコパンダが人気。夏はあんバター塩がおすすめ！",
      zip: "657-0837",
      info: {
    ...
    // TODO: 電話番号が未回答（冊子にも記載なし）。掲載可否を含めて要ヒアリング
    {
      slug: "mochi-books",
    ...
    // TODO: 冊子の営業時間は「8:30-17:00」。統合版の「8:30-17:30」と相違。要確認
    {
      slug: "mori-shoten",
      name: "畳インテリア(資)森商店",
      category: "other",
